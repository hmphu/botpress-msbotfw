...
* @Last Modified time: 2017-11-23 01:41:21
*/
...
module.exports = {
  ...
  config: {
    applicationID: { type: 'string', required: true, env: 'MSBOTFW_APP_ID' },
    applicationPassword: { type: 'string', required: true, env: 'MSBOTFW_APP_PASSWORD' },
  },
  ...
  ready: async function (bp, configurator) {
    ...
    const router = bp.getRouter('botpress-msbotfw', { auth: false })
